...
std::array<uint64_t, 97264> magic_lookup;

std::array<uint64_t, 64> magic_bishop_rays;
std::array<uint64_t, 64> magic_rook_rays;

magic_info const BISHOP_MAGICS[64] =
{
...
magic_info const ROOK_MAGICS[64] =
{
