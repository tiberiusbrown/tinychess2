...
static tunable_param const params[] =
{
    ...
    TUNABLE_PARAM_ARRAY(KNIGHT_PAWN_ADJUST, -500, 500, true),
    TUNABLE_PARAM_ARRAY(KNIGHT_ENEMY_PAWN_ADJUST, -500, 500, true),
    ...
    TUNABLE_PARAM_ARRAY(BISHOP_PAWN_ADJUST, -500, 500, true),
    TUNABLE_PARAM_ARRAY(BISHOP_ENEMY_PAWN_ADJUST, -500, 500, true),
    ...
    TUNABLE_PARAM_ARRAY(ROOK_PAWN_ADJUST, -500, 500, true),
    TUNABLE_PARAM_ARRAY(ROOK_ENEMY_PAWN_ADJUST, -500, 500, true),
    TUNABLE_PARAM_ARRAY_SUB(ROOK_MOBILITY  , -500, 500, 4, 1, 15, true),
    TUNABLE_PARAM_ARRAY(QUEEN_PAWN_ADJUST, -500, 500, true),
    TUNABLE_PARAM_ARRAY(QUEEN_ENEMY_PAWN_ADJUST, -500, 500, true),
